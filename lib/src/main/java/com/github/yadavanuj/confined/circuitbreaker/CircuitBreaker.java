...
public interface CircuitBreaker {
    boolean isPermitted(String key) throws CircuitBreakerException;

    CircuitBreaker createOrGet(CircuitBreakerConfig config);
    ...
    public class Implementation implements CircuitBreaker {

        private final io.github.resilience4j.circuitbreaker.CircuitBreaker circuitBreaker;

        public Implementation(io.github.resilience4j.circuitbreaker.CircuitBreaker circuitBreaker) {
            this.circuitBreaker = circuitBreaker;
        }

        @Override
        public boolean isPermitted(String key) throws CircuitBreakerException {
            return circuitBreaker.tryAcquirePermission();
        }

        @Override
        public CircuitBreaker createOrGet(CircuitBreakerConfig config) {
            return null;
        }
    }
}
